...
<body>
   ...
   <nav id="navigration" class="navbar fixed-top p-0">
      <div class="container">
         ...
         <a class="logo" href="#">SAS</a>
         <div class="sidenav">
            <div class="header">
               <a class="logo d-lg-none" href="#">SAS</a>
               <a href="#" class="d-lg-none" id="showsidenav"><img src="img/icon/letter-x.png" alt=""> </a>
            </div>
            <ul class="mb-0">
               <li class="nav-item"><a class="nav-link" href="index.html">Home</a></li>
               <li class="nav-item dropdown">
                  <a class="nav-link" data-toggle="collapse" href="#menu1">Who we are <i class="fal fa-angle-down"></i></a>
                  <div id="menu1" class="dropdown-menus collapse">
                     <a class="dropdown-item" href="#"><span>About Us</span></a>
                     <a class="dropdown-item" href="#"><span>Our Team</span></a>
                     <a class="dropdown-item" href="#"><span>Development Process</span></a>
                     <a class="dropdown-item" href="#"><span>Our Clients</span></a>
                     <a class="dropdown-item" href="#"><span>Contact Us</span></a>
                     <a class="dropdown-item" href="#"><span>Careers</span></a>
                     <a class="dropdown-item" href="#"><span>Mission & Vision</span></a>
                     <a class="dropdown-item" href="#"><span>Development Process</span></a>
                     <a class="dropdown-item" href="#"><span>Client Reviews</span></a>
                  </div>
               </li>
               <li class="nav-item dropdown">
                  <a class="nav-link" data-toggle="collapse" href="#menu2">Portfolio <i class="fal fa-angle-down"></i></a>
   ...
   <section id="footerSection">
      <div class="container">
         <div class="row">
            <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
               <div class="footer-box">
                  <a href="#" class="logo">Super App SOlution</a>
                  <p class="about">Welcome to our app development design agency. Lorem ipsum simply free text dolor sited amet cons cing elit.</p>
         ...
         <div class="copy-right">
            <div class="row">
               <div class="col">
                  <span>Copyright © 2021 SAS. All rights reserved.</span>
               </div>
            </div>
         </div>
      </div>
